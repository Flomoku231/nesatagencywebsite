        ...
        <div className="Training__information--text">
          <Rotate bottom left>
            ...
            <p id="TextContent--Paragraph">
              ...
              clients. NESAT Agency return qualified personnel back to workplace
              and society to positively impact those around them. As an
              institution, we offer a wide range of study fields, all of which
              are strictly developed and measured to international standards,
              remaining relevant to our clients.  We custom design our training
              programs to suit specific requirements and our client’s calendars.
            </p>
            <h2 id="TextContent--BoldText">We Offered the Following Courses</h2>
            <ul className="Courses__Offered">
              <li>Human Resource Management </li>
              <li>General Ethics & Research Skills </li>
